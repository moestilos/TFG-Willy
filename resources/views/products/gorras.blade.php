...
<body class="min-h-screen bg-black">
    ...
    <div class="container mx-auto px-4 py-12 relative z-10">
        <div class="text-center space-y-2 mb-12 animate-fade-in-up">
            <h1 class="text-4xl md:text-5xl font-light text-white">Gorras</h1>
                ...
                <div class="group relative animate-fade-in-up" style="animation-delay: {{ $i * 100 }}ms">
                    ...
                    <div class="relative bg-black/30 backdrop-blur-md rounded-xl border border-red-500/10 overflow-hidden">
                        <div class="aspect-square relative overflow-hidden">
                            <img src="{{ asset("img/g{$i}.png") }}" alt="Gorra {{ $i }}" 
                        ...
                        <div class="p-6 border-t border-red-500/10 bg-black/20">
                            <p class="text-red-400 text-xs uppercase tracking-widest mb-1">Gorra</p>
                            ...
                            <p class="text-2xl text-white font-light mb-6">${{ number_format(14.99 + $i, 2) }}</p>
                            ...
                            @auth
                                <form action="{{ route('cart.add') }}" method="POST" class="space-y-4">
                                    ...
                                    <input type="hidden" name="price" value="{{ 14.99 + $i }}">
                                    
                                    <!-- Selector de talla -->
                                    <div class="grid grid-cols-3 gap-2">
                                        @foreach(['S/M', 'M/L', 'L/XL'] as $size)
