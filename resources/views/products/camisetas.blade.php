...
<body class="min-h-screen py-12" 
    ...
    <div class="container mx-auto px-4">
        ...
        <h1 class="text-6xl text-yellow-400 font-semibold mb-12 text-center tracking-wider">Camisetas</h1>
            ...
            @for($i = 1; $i <= 10; $i++)
                <div class="bg-black rounded-xl border border-gray-700 hover:border-yellow-500/50 transition-all duration-700 overflow-hidden cursor-pointer group">
                    <div class="relative aspect-square overflow-hidden">
                        <img src="{{ asset('img/cf.png') }}" alt="Camiseta front" 
                    ...
                    <div class="p-6 border-t border-gray-700 bg-black">
                        ...
                        <p class="text-4xl text-white font-light tracking-wider mb-4">${{ 19.99 + $i }}</p>
                        @auth
